...
public class StateDesign extends JPanel {
    ...
    protected Font MENUBUTTON_FONTANDSIZE = loadCustomFont("/font/Retro-pixelfont.ttf", 44f);
    ...
    public StateDesign() {
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ResponsiveMenus.adjustComponentSizes(StateDesign.this, MENUBUTTON_FONTANDSIZE, SWITCH_USER_FONTANDSIZE, logoImage, logoLabel, originalLogoWidth, originalLogoHeight);
            }
        });
    }
}